...
function customItemString($menuItem,$user_id){
  ...
  if($menuItem['label']=='{{hr}}') { $itemString = "<div class='dropdown-divider'></div>"; } //some material css files will ignore this
...
function customDropdownString($menuItem,$user_id){
	$itemString='';
  //material usually uses divs, bs3 often uses li tags here
  ...
  //material usually uses divs, bs3 often uses ul tags here
