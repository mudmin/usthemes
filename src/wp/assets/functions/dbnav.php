...
function customItemString($menuItem,$user_id){
  ...
  if($menuItem['label']=='{{hr}}') { $itemString = "<div class='dropdown-divider'></div>"; } //some wp css files will ignore this
...
function customDropdownString($menuItem,$user_id){
	$itemString='';
  //wp usually uses divs, bs3 often uses li tags here
  ...
  //wp usually uses divs, bs3 often uses ul tags here
