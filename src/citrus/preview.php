...
<!-- Bootstrap Core CSS -->
<link rel="stylesheet" href="<?=$us_url_root?>usersc/templates/citrus/assets/css/bootstrap.min.css">
...
<script src="<?=$us_url_root?>usersc/templates/citrus/assets/js/bootstrap.min.js" type="text/javascript"></script>
...
<?php require_once($abs_us_root.$us_url_root.'usersc/templates/citrus/assets/functions/style.php');?>
...
require_once($abs_us_root.$us_url_root.'usersc/templates/citrus/assets/functions/nav.php');
}


 if($settings->navigation_type==1) {
 require_once($abs_us_root.$us_url_root.'usersc/templates/citrus/assets/functions/dbnav.php');
} ?>
...
<?php
require_once $abs_us_root . $us_url_root . 'usersc/templates/citrus/container_open.php'; //custom template container
?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="list-inline text-center">
                    <li class="list-inline-item py-1"><a href="" data-target="#myModal" data-toggle="modal" class="btn btn-outline-secondary btn-sm">Citrus</a></li>
...
<?php require_once $abs_us_root . $us_url_root . 'usersc/templates/citrus/container_close.php'; //custom template container  ?>

<?php require_once $abs_us_root . $us_url_root . 'users/includes/page_footer.php'; ?>

<?php require_once $abs_us_root . $us_url_root . 'usersc/templates/citrus/footer.php'; //custom template footer ?>
