...
<!-- Bootstrap Core CSS -->
<link rel="stylesheet" href="<?=$us_url_root?>usersc/templates/comix/assets/css/bootstrap.min.css">
...
<script src="<?=$us_url_root?>usersc/templates/comix/assets/js/bootstrap.min.js" type="text/javascript"></script>
...
<?php require_once($abs_us_root.$us_url_root.'usersc/templates/comix/assets/functions/style.php');?>
...
require_once($abs_us_root.$us_url_root.'usersc/templates/comix/assets/functions/nav.php');
}


 if($settings->navigation_type==1) {
 require_once($abs_us_root.$us_url_root.'usersc/templates/comix/assets/functions/dbnav.php');
} ?>
...
<?php
require_once $abs_us_root . $us_url_root . 'usersc/templates/comix/container_open.php'; //custom template container
?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="list-inline text-center">
                    <li class="list-inline-item py-1"><a href="" data-target="#myModal" data-toggle="modal" class="btn btn-outline-secondary btn-sm">comix</a></li>
...
<?php require_once $abs_us_root . $us_url_root . 'usersc/templates/comix/container_close.php'; //custom template container  ?>

<?php require_once $abs_us_root . $us_url_root . 'users/includes/page_footer.php'; ?>

<?php require_once $abs_us_root . $us_url_root . 'usersc/templates/comix/footer.php'; //custom template footer ?>
